...
#define ELFIN_HOSTIFB_BASE		0x74100000

/* Host I/F B - Modem I/F */

#define HOSTIFB_INT2AP_REG		__REG(ELFIN_HOSTIFB_BASE+0x8000)
#define HOSTIFB_INT2MSM_REG		__REG(ELFIN_HOSTIFB_BASE+0x8004)
#define HOSTIFB_MIFCON_REG		__REG(ELFIN_HOSTIFB_BASE+0x8008)
#define HOSTIFB_MIFPCON_REG		__REG(ELFIN_HOSTIFB_BASE+0x800C)
#define HOSTIFB_MSMINTCLR_REG	__REG(ELFIN_HOSTIFB_BASE+0x8010)
